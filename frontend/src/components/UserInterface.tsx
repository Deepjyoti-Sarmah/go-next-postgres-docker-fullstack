...
const UserInterface: React.FC<UserInterfaceProps> = ({ backendName }) => {
    ...
    return (
        <div className={`user-interface ${bgColor} ${backendName} w-full max-w-md my-4 rounded shadow`}>
            ...
            <form onSubmit={createUser}
                className="mb-6  mt-2 mx-2 p-4 bg-blue-100 rounded shadow text-black"
            >
                <input
                    placeholder="Name"
                    value={newUser.name}
            ...
            {/* update user */}
            <form onSubmit={handleUpdateUser} className="mb-6 mx-2 p-4 bg-blue-100 rounded shadow text-black">
                <input
                    placeholder="User Id"
                    value={updateUser.id}
